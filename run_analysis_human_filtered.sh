...
# --excel TRUE \
# --text TRUE \
# --outdir results/human_filtered/diffexpr-399_2-vs-370_1
...
# --excel TRUE \
# --text TRUE \
# --outdir results/human_filtered/diffexpr-399_2-vs-370_5
...
# --excel TRUE \
# --text TRUE \
# --outdir results/human_filtered/diffexpr-370_1-vs-370_5
...
# --excel TRUE \
# --text TRUE \
# --outdir results/human_filtered/diffexpr_treat_vs_control
