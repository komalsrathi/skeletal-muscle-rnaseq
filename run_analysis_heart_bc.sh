...
--excel TRUE \
--text TRUE \
--outdir results/heart_bc/within-strain-ex-vs-nonex
...
--excel TRUE \
--text TRUE \
--outdir results/heart_bc/between-strain-nonex
...
--excel TRUE \
--text TRUE \
--outdir results/heart_bc/between-strain-ex
...
--width 15 \
--height 6 \
--outdir results/heart_bc/expression-plots
